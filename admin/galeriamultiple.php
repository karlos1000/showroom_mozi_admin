...
if(isset($_GET["activazonaid"]))
{
    if($_GET["activazonaid"] > 0)
    {
        ...
        $resultGrid = $versionZonasActivasObj->GetVersionZonaActivaGrid($_GET["activazonaid"]);
    }
    else
    {
...
<head>
    ...
    <title>Galeria multiple - <?php echo $titulo; ?></title>
    ...
    <script type="text/javascript" src="../js/uploadmulti.js"></script>
