...
<head>
    ...
    <script type="text/javascript">
      $( document ).ready(function() {
        var params = {selector:"#vgcaracteristicas", height:"230", btnImg:true, readonly:0};
                              ...
                              <div id="home" class="tab-pane fade in <?php echo $tabActiveGral ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-4">
                                        <select class="form-control required" name="vg_modelo" id="vg_modelo">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-4">
                                        <input type="text" id="vg_version" name="vg_version" value="<?php echo $versionGeneralesObj->version;?>" class="form-control required">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="text-right form-group col-md-2 col-sm-2 col-xs-3">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-4">
                                        <input type="text" id="vg_codigoversion" name="vg_codigoversion" value="<?php echo $versionGeneralesObj->codigoVersion;?>" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-8 col-sm-8 col-xs-8">
                                    <!-- accept="image/*"  -->                                                                        
                                     <?php if($versionGeneralesObj->imagen!=''){ ?>                                        
                                        <div style="display:inline-block;">
                                          <input type="file" name="imagen" id="vg_imagen" size="10" class="form-control" accept="image/gif, image/jpg, image/jpeg, image/png" />
                                        </div>
                                        <div style="display:inline-block;">
                                    ...
                                    <?php }else{ ?>                
                                        <input type="file" name="imagen" id="vg_imagen" size="10" class="form-control required" accept="image/gif, image/jpg, image/jpeg, image/png" />
                                    <?php } ?>
                                  </div>
                                </div>
                                  ...
                                  <div class="col-md-4 col-sm-4 col-xs-4">
                                    <!-- accept="image/*"  -->                                                                        
                                     <?php if($versionGeneralesObj->urlPdf!=''){ ?>                                        
                                        ...
                                        <input type="file" name="pdfCarac" id="pdfCarac" size="10" class="form-control" accept="application/pdf, application/x-download" />                                        
                                    <?php }else{ ?>                
                                        <input type="file" name="pdfCarac" id="pdfCarac" size="10" class="form-control" accept="application/pdf, application/x-download" />
                                    <?php } ?>
