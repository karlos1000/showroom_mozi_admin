...
<table class="table-sinbordered tblContEstimacion" width="545">
  ...
  <tr>
    <td>1 CELULAR:</td>
    <td width="198"><?php echo $colDetalles->pv_celular; ?></td>
    <td width="65">3 CASA:</td>
    <td width="209"><?php echo $colDetalles->pv_casa; ?></td>
  </tr>
  <tr>
    <td>2 OFICINA:</td>
...
<table class="table-sinbordered tblContEstimacion" width="545">
  ...
  <tr>
    <td width="13">&nbsp;</td>
    <td width="88">&nbsp;</td>
    <td width="120" class="text_center"><b>VENDEDOR</b></td>
    <td width="106">&nbsp;</td>
    <td width="135" class="text_center"><b>CLIENTE</b></td>
    <td width="96">&nbsp;</td>
    <td width="12">&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td class="text_center"><?php echo strtoupper($arrDatosGrales->nombreVendedor); ?></td>
    <td>&nbsp;</td>
    <td class="text_center"><?php echo strtoupper($colDetalles->pv_nombre); ?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>&nbsp;</td>
    <td><?php echo $arrDatosGrales->gerentevwsf; ?></td>
    <td>&nbsp;</td>
    <td><?php echo $arrDatosGrales->gerenteventas; ?></td>
    <td>&nbsp;</td>
    <td><?php echo $arrDatosGrales->gerentegral; ?></td>
    <td>&nbsp;</td>
  </tr>
</table>
