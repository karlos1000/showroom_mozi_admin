...
if($gralVersId > 0)
{
    $requisitos = $versionRequisitosObj->ObtVersionesRequisitos(false, $gralVersId, 1);
...
<head>
    ...
    <title>Requisitos <?php echo $gamaModelosObj->modelo."-".$gamaModelosObj->anio. " ".$versionGeneralesObj->version ?></title>
    ...
    <section class="section-internas">
        <div class="panel-body">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-9">
                        <h1 class="titulo">Requisitos <?php echo $gamaModelosObj->modelo."-".$gamaModelosObj->anio. " ".$versionGeneralesObj->version ?></h1>       
                        
                        <?php
                        foreach ($requisitos as $requisito) {
                            echo '<h3>'.$requisito->concepto.'</h3>';
                            echo $requisito->caracteristicas.'<hr>';
                        }
